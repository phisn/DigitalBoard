...
namespace Game
{
	...
	public:
		...
		GameController(Framework::EventConfiguration* const eventConfig)
			:
	...
	private:
		bool Restore()
		{
			...
			if (!eventConfiguration->GetHandler<Framework::RestoreEventHandler>()->Ask(&data))
			{
				return false;
			}
		...
		Framework::EventConfiguration* const eventConfiguration;
